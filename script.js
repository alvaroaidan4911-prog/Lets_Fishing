...
function buildIsland(x,z,radius,grassRadius,label,grassColor){
  ...
  leaves.position.y=9.3; g.add(leaves);
  // Sign
...
function mountJetski(){
  ...
  player.position.copy(jetski.position);player.position.y=jetski.position.y+0.2;
...
function updateJetski(){
  ...
  player.position.copy(jetski.position);player.position.y=jetski.position.y+0.5;
